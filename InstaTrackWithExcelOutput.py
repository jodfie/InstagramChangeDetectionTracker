...
InstaTrack and Excel Converter Script By Snbig
https://github.com/Snbig/InstaTrack/
Merged together by MagicalCodeMonkey for Jodfie
...
def main():
    ...
    if args.file is not None:
        ...
        toExcel('results.txt')
        print('[++] Results converted to InstaTracker.xls')
        return 0
